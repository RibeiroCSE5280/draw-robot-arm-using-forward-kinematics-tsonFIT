...
def forward_kinematics(phi, l1, l2, l3, l4):
    ...
    t_x_1 = np.array([[l1 * 1.0], [0.0], [0.0]])
    t_x_2 = np.array([[l2 * 1.0], [0.0], [0.0]])
    t_x_3 = np.array([[l3 * 1.0], [0.0], [0.0]])
    t_x_4 = np.array([[l4 * 1.0], [0.0], [0.0]])
    ...
    T_45 = getLocalFrameMatrix(np.identity(3), t_x_4)
